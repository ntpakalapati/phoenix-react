                    ...
                    {!isSearchOpen ? (
                      <div className='flex gap-0 md:gap-2'>
                        <div className='w-[15%] md:w-[37%] flex justify-center md:justify-start items-center'>
                          <div onClick={handleSearchClick} className='bg-[#F0F0F0] p-2 w-11 h-11 md:w-12 md:h-12 rounded-full'>
                      ...
                      <div className="flex items-center gap-2 relative">
                        ...
                        <input type="text" className="border-[2px] focus:outline-none  py-[4.5px] w-96 rounded-full px-8 border-gray-300" placeholder="Search..." />
